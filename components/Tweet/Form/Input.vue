  ...
  <div>
    <div class="flex flex-shrink-0 items-center p-4 pb-0">
      ...
      <div class="w-full p-2">
        <textarea
          class="h-10 w-full border-0 bg-transparent text-lg text-gray-900 placeholder:text-gray-400 focus:ring-0 dark:text-white"
          v-model="text"
    ...
    <div class="flex p-2 pl-14">
      <div class="flex w-full text-white">
        <div
          class="cursor-pointer rounded-full p-2 text-blue-400 hover:bg-blue-50 dark:hover:bg-dim-800"
      ...
      <div class="ml-auto">
        <UIButton @onClick="handleFormSubmit" size="sm" :disabled="isDisabled" >
...
function handleImageChange(event) {
  ...
  reader.onload = (event) => {
    imageInputUrl.value = event.target.result;
  };
